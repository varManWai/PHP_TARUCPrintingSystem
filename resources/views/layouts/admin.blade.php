...
<head>
    ...
    <title>{{ config('app.name', 'TARUC') }}</title>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item"
                                        href="{{ route('facultydashboard') }}">{{ __('Faculty Management') }}
                                    </a>                                   
                                    <a class="dropdown-item"
                                        href="{{ route('programmedashboard') }}">{{ __('Programme Management') }}
                                    </a>
                                    <a class="dropdown-item"
                                    href="{{ route('subjectdashboard') }}">{{ __('Subject Management') }}
                                    </a>
                                </div>
                            </li>
