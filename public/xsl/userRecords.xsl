    ...
    <div id="app">
        ...
        <thead>
            <tr>
                ...
                <th scope="col" class="text-center">ProgrammeID</th>
        ...
        <tbody>
            ...
            <td class="text-center"><xsl:value-of select="programmeID"/></td>
        ...
        <div class="text-center">
                    <button onclick="window.print();"  class="btn btn-dark" id="print-btn">Print</button>
        </div>
    </div>
</div>
</div>
